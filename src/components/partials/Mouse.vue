<template>
    <div class="mouse flex text-center flex-col items-center mt-4">
        ...
        <svg
        ref="arrow"
         class="pt-2" width="20" height="33" viewBox="0 0 24 37" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export default {
    ...
    components : {
        ...
        TweenLite.to(arrow, {transform: "translateY(10px)", repeat:-1, yoyo:true})
    }
}
</script>
